...
//        $array = (new ClassToArray())->classToArray($this);
        ...
        public function adicionarDoenca(int $doencaId, string $situacao = 'CURADO', int $animalId = null)
        {
            $doenca = new Doenca();
            $doenca->setId($doencaId);
            $doenca->setSituacao($situacao);
            if ($animalId != null) $doenca->getAnimal()->setId($animalId);
        ...
        public function adoecerAnimal($idAnimal = null)
        {
            foreach ($this->doencas as $doenca) {
                (new DoencaDAO())->adoecer($this->id == null ? $idAnimal : $this->id, $doenca->getSituacao(), $doenca->getId());
            }
        }

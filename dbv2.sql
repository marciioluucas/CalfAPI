...
--
-- Host: localhost:8889
-- Generation Time: Dec 04, 2018 at 10:30 PM
...
(1, 'Mimosa', '', '2017-04-11', 0, 'Não informado', 'Não informado', 0, '2018-11-15 11:14:58', '2018-02-13 00:00:00', 1, NULL, 1, 1, 'BEZERRO'),
...
INSERT INTO `funcionarios` (`id`, `cargo_id`, `pessoa_id`, `usuario_id`, `salario`, `data_alteracao`, `data_cadastro`, `usuario_cadastro`, `usuario_alteracao`, `status`, `fazenda_id`) VALUES
(1, 9, 1, 3, '3000.00', '2018-10-04 06:38:57', '2018-10-04 06:38:57', 1, NULL, 1, 1),
(2, 11, 5, 5, '123456.00', '2018-10-28 14:52:09', '2018-10-28 14:52:09', 1, NULL, 1, 5),
(3, 13, 7, 22, '123456.00', '2018-11-05 19:09:41', '2018-11-05 19:09:41', 1, NULL, 1, 5),
(4, 11, 12, 25, '123456.00', '2018-11-14 17:31:44', '2018-11-14 17:31:44', 1, NULL, 1, 1);
...
INSERT INTO `usuarios` (`id`, `grupo_id`, `login`, `senha`, `data_alteracao`, `data_cadastro`, `usuario_cadastro`, `usuario_alteracao`, `status`) VALUES
(3, 2, 'brunnousername', 'useruser', '2018-09-27 16:08:49', '2018-09-27 16:08:49', 1, 1, 1),
(4, 3, 'brunno', 'brunno', '2018-09-28 10:00:29', '2018-09-28 10:00:29', 1, NULL, 1),
(5, 6, 'pablo14', 'pablo14', '2018-09-28 10:15:48', '2018-09-28 10:02:09', 1, 1, 1),
(17, NULL, 'miltonvieira', 'milton123', '2018-11-14 17:15:21', '2018-10-28 14:02:40', 1, NULL, 0),
(18, NULL, 'milton1234', '12345678', '2018-11-14 17:15:25', '2018-10-28 14:05:06', 1, NULL, 0),
(19, 7, 'milton12345', '12345678', '2018-11-14 17:15:27', '2018-10-28 14:08:51', 1, NULL, 0),
(20, 7, 'milton123', '12345678', '2018-11-14 17:15:30', '2018-10-28 14:10:27', 1, NULL, 0),
(21, 6, 'divina123', 'divina123', '2018-10-28 14:20:30', '2018-10-28 14:20:30', 1, NULL, 1),
(22, 8, 'joslaine123', 'joslaine12345', '2018-11-05 19:09:27', '2018-11-05 19:09:27', 1, NULL, 1),
(23, NULL, 'userbrunno', 'Brunno7676', '2018-11-10 08:37:30', '2018-11-10 08:37:28', 1, NULL, 1),
(24, NULL, 'userPablo', 'Pablo123', '2018-11-10 08:53:42', '2018-11-10 08:53:42', 1, NULL, 1),
(25, 7, 'miltonvieira', 'cristorei123', '2018-11-14 17:19:25', '2018-11-14 17:19:25', 1, NULL, 1);
...
ALTER TABLE `funcionarios`
  ...
  ADD KEY `funcionarios_usuarios` (`usuario_id`),
...
ALTER TABLE `usuarios`
  ADD PRIMARY KEY (`id`),
  ADD KEY `usuarios_grupos` (`grupo_id`);
...
ALTER TABLE `funcionarios`
  ...
  ADD CONSTRAINT `funcionarios_usuarios` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON UPDATE CASCADE;
